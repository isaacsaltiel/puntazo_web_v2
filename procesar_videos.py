...
print("🟦 Usando cuenta Cloudinary 2")
...
# === Configuración Cloudinary - Cuenta 2 ===
...
for video in videos_nuevos:
    ...
    print(f"🚀 Procesando: {nombre} (usando cuenta Cloudinary 2)")
        ...
        if job_id:
            ...
            while intentos < max_intentos:
                ...
                if status.is_complete():
                    break
                if status.is_failed():
                    print(f"⚠️ Falló la descarga de {nombre}")
...
print("🏁 Todos los videos fueron procesados con la cuenta Cloudinary 2.")
